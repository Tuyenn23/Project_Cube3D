                    ...
                    if (endValueTransform == null) {
                        ...
                        if (targetType == TargetType.RectTransform) {
                            ...
                            if (endValueT == null) {
                                ...
                                if (rTarget == null) {
                                    Debug.LogWarning(string.Format("{0} :: This tween's target and TO target are not of the same TypeShop. Please reassign the values", this.gameObject.name), this.gameObject);
                                } else {
